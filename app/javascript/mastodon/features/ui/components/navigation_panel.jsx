...
import FaqIcon from '@/material-icons/400-24px/question_mark.svg?react';
        ...
        <div className='navigation-panel__menu'>
          ...
          {signedIn && (
            <>
              ...
              <ColumnLink transparent href='https://faq.imastodon.net/getting-started/' icon='question' iconComponent={FaqIcon} text={intl.formatMessage(messages.faq)} target='_blank' />
