...
const startServer = async () => {
  ...
  const channelNameToIds = (req, name, params) => new Promise((resolve, reject) => {
    ...
    case 'hashtag':
      ...
      resolveFeed('hashtag', `timeline:hashtag:${normalizeHashtag(params.tag)}${req.accountId ? ':authorized' : ''}`, { needsFiltering: true });
    ...
    case 'hashtag:local':
      ...
      resolveFeed('hashtag', `timeline:hashtag:${normalizeHashtag(params.tag)}${req.accountId ? ':authorized' : ''}:local`, { needsFiltering: true });
