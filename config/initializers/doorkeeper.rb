...
Doorkeeper.configure do
  ...
  # Development: enabled for e2e testing
  resource_owner_from_credentials do |_routes|
    next nil unless Rails.env.development?
  ...
  grant_flows Rails.env.development? ? %w(authorization_code client_credentials password) : %w(authorization_code client_credentials)
